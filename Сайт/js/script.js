...
const quotes = [
    ...
    { text: "Жизнь - это путешествие, которое must be travelled, как бы плохи ни были дороги и жилье.", author: "Оливер Голдсмит", category: "жизнь" },
    ...
    { text: "Мудрость начинается в wonder.", author: "Сократ", category: "мудрость" },
    ...
    { text: "Успех - это не окончательный, неудача - не фатальна: значение имеет лишь мужество продолжать.", author: "Уинстон Черчилль", category: "успех" },
    { text: "Мудрость - это дочь опыта.", author: "Леонардо да Винчи", category: "мудрость" },
    { text: "Мотивация comes from working on things we care about.", author: "Шерил Сэндберг", category: "мотивация" },
